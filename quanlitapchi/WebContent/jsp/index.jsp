		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="mynav nav navbar-nav navbar-right">
					<li class=" selected"><a  href="index.jsp" title="Home"> <span
							class="icon"><i class="glyphicon glyphicon-home"
								title="Trang Chủ"></i></span> <span>Trang Chủ</span>
					</a></li>
					<li><a class="" href="register.jsp" title="Đăng Ký"> <span
							class="icon"><i class="fa fa-share-alt" title="Join Us"></i></span>
							<span>Đăng Ký</span>
					</a></li>

					<li><a class="" href="contact.jsp" title="Liên Hệ"> <span
							class="icon"><i class="fa fa-phone"></i></span> <span>Liên
								Hệ</span>
					</a></li>

					<li><a class="" href="signin.jsp" title="Đăng Nhập"> <span
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input type="text" placeholder="Search.." id="keyword"
										...
										title="4 to 40 characters" autocomplete="off"
