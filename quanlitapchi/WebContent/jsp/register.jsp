	...
	<div class="container">
		<div class="panel pannel-default input_">
			<div class="panel-body">
				...
				<div class="col-md-6">
					<form class="form-horizontal" action="register_youraccount.jsp" method="post" role="form" accept-charset="UTF-8">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="email" value="" name="email"  required
									placeholder="Enter a valid email address" class="form-control">
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="btn col-md-3 " align="left">
								<input class=" btn-default" type="button" title="cancel"
									value="Hủy bỏ">
							</div>
							...
							<div class="btn col-md-3" align="right">
								<input class=" btn-default" type="submit" title="continue" name="first"
									value="Tiếp tục >>">
							</div>
						</div>						
					</form>
