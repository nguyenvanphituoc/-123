...
%>
<title>Nhà Phản Biện <%=us.getuLastname()%></title>
		...
		<div class="row">
			<div class="col-lg-12 col-sm-12 col-md-12">
				<h1 class="page-header">
					Tập Chí Khoa Học Kỹ Thuật <small>Reviewer <%=us.getuLastname()%></small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="index.jsp">Home</a></li>
					<li class="active">Reviewer <%=us.getuLastname()%></li>
				</ol>
			</div>
		</div>
	</div>
