...
<!-- animsition -->
<link href="../css/anmsition/anmsition.min.css">
<!-- Custom Fonts -->
	...
	<nav class="navbar navbar-inverse navbar-fixed-top animsition"
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="animsition-link" href="index.jsp"><img alt=""
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<p>
					1 Võ Văn Ngân<br>Phường Linh Chiểu, Quận Thủ Đức, TP.Hồ Chí
					Minh<br>
				</p>
				<p>
					<i class="fa fa-phone"></i> <abbr title="Phone">P</abbr>:<a
		...
		<!-- sì lô gun -->
		<div class="row">
			<p class="h3 col-md-12">Our goal is to provide friendly and
				responsive support. Choose from the following contact list below for
				the specific team to handle your needs. We value feedback from our
				customers and are committed to providing you with our very best in
				customer service.</p>
		</div>
		<!-- Contact Form -->
			...
			<div class="col-md-8 col-md-offset-2 form_content row">
				...
				<div class="col-md-12 contact_form_noti">
					<p>If you have any questions: Please fill out the form and a
						customer service representative will reply to your inquiry within
						24 hours.</p>
				</div>
				<form class="form form-horizontal contact_form" name="sentMessage"
					id="contactForm" role="form" action="" method="get">
					<div class="form-group">
						<label class="col-md-3 control-label">Select your title:*</label>
						<div class="col-md-7">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Journals/
							ConferenceName:*</label>
						<div class=" col-md-7">
							<select class="form-control" required name="journal">
								<option selected="selected" value="">--Please select--</option>
								<option value="United States">United States</option>
								<option value="United Kingdom">United Kingdom</option>
								<option value="Afghanistan">Afghanistan</option>
					...
					<div class="form-group">
						<button type="submit"
							class="btn btn-primary pull-right contact_btn">Send
							Question</button>
					</div>
				</form>
